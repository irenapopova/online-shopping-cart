<h1>E-Commerce Shopping cart - React + Redux + Firebase application </h1>

## Introduction

E-commerce shopping cart application built in React, Redux and Firebase. Uses Firestore  for storing data.
...
- execute the following command on terminal in the project directory:
